                            ...
                            case "statusantrean":
                                ...
                                if((!empty($header['x-token'])) && (USERNAME==$header['x-username']) && (cektoken($header['x-token'])=='true')){
                                    if(empty($decode['kodepoli'])) { 
                                        ...
                                        $kddokter   = getOne2("SELECT kd_dokter FROM maping_dokter_dpjpvclaim WHERE kd_dokter_bpjs='".validTeks($decode['kodedokter'])."'");
                                        $ardokter   = fetch_array(bukaquery2("SELECT kd_dokter,nm_dokter_bpjs FROM maping_dokter_dpjpvclaim WHERE kd_dokter_bpjs='".validTeks($decode['kodedokter'],20)."'"));
                                        ...
                                        {
                                          $nm_dokter=$ardokter['nm_dokter_bpjs'];
                                        }
                                        ...
                                        if(empty($kdpoli)) { 
                                            $response = array(
                                                'metadata' => array(
                                                    //'message' => 'Poli tidak ditemukan',
                                                    'message' => 'Jadwal Dokter '.$nm_dokter.' Tersebut Belum Tersedia, Silahkan Reschedule Tanggal dan Jam Praktek Lainnya',
                                                    'code' => 201
                                                )
                                            );
                                            http_response_code(201);
                                            ...
                                            if(empty($kuota)) {
                                                ...
                                                $data = fetch_array(bukaquery2("SELECT poliklinik.nm_poli,COUNT(reg_periksa.kd_poli) as total_antrean,dokter.nm_dokter,
                                                    ...
                                                    WHERE reg_periksa.tgl_registrasi='".validTeks($decode['tanggalperiksa'])."' AND reg_periksa.kd_poli='$kdpoli' and reg_periksa.kd_dokter='$kddokter'"));

                                                $str_noantri=getOne2("select reg_periksa.no_reg from reg_periksa where reg_periksa.stts='Berkas Diterima' and reg_periksa.kd_dokter='$kddokter' and reg_periksa.kd_poli='$kdpoli' and reg_periksa.tgl_registrasi='".validTeks($decode['tanggalperiksa'])."' order by CONVERT(RIGHT(reg_periksa.no_reg,3),signed) limit 1 ");
                                                if($str_noantri=='')
                                                {
                                                    $antreanpanggil='';
                                                }    
                                                ...
                                                {
                                                    $antreanpanggil=$kdpoli."-".$str_noantri;
                                                }
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                { 
                                                  ...
                                                  */
                                                  $arpxbaru=cekpasien_baru(validTeks($decode['nik']),validTeks($decode['nomorkartu']));                                      
                                                  if(empty($arpxbaru['nomorkartu']))
                                                  {
                                                    $response = array(
                                                      'metadata' => array(
                                                        'message' =>  'Data pasien tidak ditemukan, silahkan Melakukan Registrasi Pasien Baru',
                                                        'code' => 202
                                                      )
                                                    ); 
                                                    http_response_code(202);   
                                                  ...
                                                  else
                                                  {
                                                    $response = array(
                                                      'metadata' => array(
                                                      'message' =>  'Anda sudah mempunyai no rekam medis sementara. Harap datang ke admisi untuk verifikasi dan melengkapi data rekam medis dengan membawa kartu identitas. Pastikan data anda benar-benar valid dan belum pernah terdaftar di RS Bedah Surya Dharma Husada Jombang',
                                                      'code' => 201
                                                      )
                                                    ); 
                                                    http_response_code(201);                                                          
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                if ($sisakuota < $jadwal['kuota']) {
                                                                    ...
                                                                    $noReg           = noRegPoli($kdpoli,$kddokter,validTeks($decode['tanggalperiksa']));
                                                                    ...
                                                                    $maxbooking      = getOne2("select ifnull(MAX(CONVERT(RIGHT(nobooking,6),signed)),0)+1 from referensi_mobilejkn_bpjs where tanggalperiksa='".validTeks($decode['tanggalperiksa'])."'");
                                                                    ...
                                                                    if ($querybooking) 
                                                                    {
                                                                        ...
                                                                        else 
                                                                        {
                                                                            ...
                                                                            $response = array(
                                                                                'metadata' => array(
                                                                                    'message' => "Maaf terjadi kesalahan, hubungi Admnistrator..(1)",
                                                                                    'code' => 401
                                                                                )
                                                                            );
                                                                    ...
                                                                    else 
                                                                    {
                                                                        $response = array(
                                                                            'metadata' => array(
                                                                                'message' => "Maaf terjadi kesalahan, hubungi Admnistrator..(2)",
                                                                                'code' => 401
                                                                            )
                                                                        );
                                                                        http_response_code(401);
                            ...
                            case "checkinantrean":
                                ...
                                if((!empty($header['x-token'])) && (USERNAME==$header['x-username']) && (cektoken($header['x-token'])=='true')){
                                    ...
                                    if(empty($decode['kodebooking'])) { 
                                        ...
                                        $booking = fetch_array(bukaquery2("select nobooking,tanggalperiksa,status,validasi,left(jampraktek,5) as jampraktek from referensi_mobilejkn_bpjs where nobooking='".validTeks($decode['kodebooking'])."'"));
                                        if(empty($booking['status'])) {
                                            ...
                                            if($booking['status']=='Batal'){
                                                ...
                                                {
                                                    $update=bukaquery2("update referensi_mobilejkn_bpjs set status='Checkin',validasi=now() where nobooking='".validTeks($decode['kodebooking'])."'");
                                                    if($update)
                                                    {
                                                        $response = array(
                                                            'metadata' => array(
                            ...
                            case "batalantrean":
                                ...
                                if((!empty($header['x-token'])) && (USERNAME==$header['x-username']) && (cektoken($header['x-token'])=='true')){
                                    if(empty($decode['kodebooking'])) { 
                                        ...
                                        $booking = fetch_array(bukaquery2("select nobooking,no_rawat,tanggalperiksa,status,validasi,nomorreferensi,norm from referensi_mobilejkn_bpjs where nobooking='".validTeks($decode['kodebooking'])."'"));
                                        if(empty($booking['status'])) {
                                            $response = array(
                                                'metadata' => array(
                                                    'message' => 'Data Booking tidak ditemukan',
                                            ...
                                            if($booking['status']=='Batal'){
                                                ...
                                                $update        = bukaquery2("update referensi_mobilejkn_bpjs set status='Batal',validasi=now() where nobooking='".validTeks($decode['kodebooking'])."'");
                                                ...
                                                if($batal){
                                                    ...
                                                    bukaquery2("insert into referensi_mobilejkn_bpjs_batal values('$booking[norm]','$booking[no_rawat]','$booking[nomorreferensi]',now(),'".validTeks($decode['keterangan'])."','Belum','$booking[nobooking]')");
                                                    http_response_code(200);
                                                }else{
                                                    $response = array(
                                                        'metadata' => array(
                            ...
                            case "sisaantrean":
                                ...
                                if((!empty($header['x-token'])) && (USERNAME==$header['x-username']) && (cektoken($header['x-token'])=='true')){
                                    if(empty($decode['kodebooking'])) { 
                                        ...
                                        $booking = fetch_array(bukaquery2("select nobooking,no_rawat,tanggalperiksa,status,validasi,nomorreferensi,kodedokter,kodepoli,jampraktek from referensi_mobilejkn_bpjs where nobooking='".validTeks($decode['kodebooking'])."'"));
                                        if(empty($booking['status'])) {
                                            $response = array(
                                                'metadata' => array(
                                                    'message' => 'Data Booking tidak ditemukan',
                                            ...
                                            if($booking['status']=='Batal'){
                                                ...
                                                */
                                                ...
                                                $data = fetch_array(bukaquery("SELECT reg_periksa.kd_poli,poliklinik.nm_poli,dokter.nm_dokter,
                                                    ...
                                                    FROM reg_periksa INNER JOIN poliklinik ON poliklinik.kd_poli=reg_periksa.kd_poli
                                                    INNER JOIN dokter ON dokter.kd_dokter=reg_periksa.kd_dokter
                                                    inner join referensi_mobilejkn_bpjs on referensi_mobilejkn_bpjs.no_rawat=reg_periksa.no_rawat 
                                                    WHERE reg_periksa.kd_dokter='$kodedokter' and reg_periksa.kd_poli='$kodepoli'and reg_periksa.tgl_registrasi='$booking[tanggalperiksa]' 
                                                    and referensi_mobilejkn_bpjs.status='Checkin' 
                                                    and CONVERT(RIGHT(reg_periksa.no_reg,3),signed)<CONVERT(RIGHT($noreg,3),signed)"));

                                                $xnodipanggil=getOne2("select max(reg_periksa.no_reg) as no_reg from reg_periksa where reg_periksa.stts='Berkas Diterima' and reg_periksa.kd_dokter='$kodedokter' and reg_periksa.kd_poli='$kodepoli' and reg_periksa.tgl_registrasi='$booking[tanggalperiksa]' and CONVERT(RIGHT(reg_periksa.no_reg,3),signed)<=CONVERT(RIGHT($noreg,3),signed) order by CONVERT(RIGHT(reg_periksa.no_reg,3),signed) limit 1 ");
                                                if($xnodipanggil=='')
                                                {
                                                    $xantreanpanggil='-';
                                                }
                                                ...
                                                {
                                                    $xantreanpanggil=$kodepoli."-".$xnodipanggil; 
                                                }

                                                if ($data['nm_poli'] != '') {
                                                    $response = array(
                                                        'response' => array(
                                                            'nomorantrean' => $kodepoli."-".$noreg,
                                                            'namapoli' => $data['nm_poli'],
                                                            'namadokter' => $data['nm_dokter'],
                                                            'sisaantrean' => intval(validangka($data['sisa_antrean'])>=0?($data['sisa_antrean']):0),
                                                            ...
                                                            'antreanpanggil' => $xantreanpanggil,    
                                ...
                                if((!empty($header['x-token'])) && (USERNAME==$header['x-username']) && (cektoken($header['x-token'])=='true')){
                                    if(empty($decode['tanggalawal'])) { 
                                        ...
                                        $queryoperasirs = bukaquery2("SELECT booking_operasi.no_rawat,booking_operasi.tanggal,paket_operasi.nm_perawatan,maping_poli_bpjs.kd_poli_bpjs,maping_poli_bpjs.nm_poli_bpjs,booking_operasi.status,pasien.no_peserta 
                                                            ...
                                                            INNER JOIN maping_poli_bpjs ON maping_poli_bpjs.kd_poli_rs=reg_periksa.kd_poli WHERE booking_operasi.tanggal BETWEEN '".validTeks($decode['tanggalawal'])."' AND '".validTeks($decode['tanggalakhir'])."' ORDER BY booking_operasi.tanggal,booking_operasi.jam_mulai");
                                ...
                                if((!empty($header['x-token'])) && (USERNAME==$header['x-username']) && (cektoken($header['x-token'])=='true')){
                                    if (empty($decode['nopeserta'])){ 
                                        ...
                                        $queryoperasipasien = bukaquery2("SELECT booking_operasi.no_rawat,booking_operasi.tanggal,paket_operasi.nm_perawatan,maping_poli_bpjs.kd_poli_bpjs,maping_poli_bpjs.nm_poli_bpjs,booking_operasi.status,pasien.no_peserta 
                                                            FROM booking_operasi INNER JOIN reg_periksa ON booking_operasi.no_rawat = reg_periksa.no_rawat INNER JOIN pasien ON pasien.no_rkm_medis = reg_periksa.no_rkm_medis INNER JOIN paket_operasi ON booking_operasi.kode_paket = paket_operasi.kode_paket 
                                                            INNER JOIN maping_poli_bpjs ON maping_poli_bpjs.kd_poli_rs=reg_periksa.kd_poli WHERE pasien.no_peserta='".validTeks($decode['nopeserta'])."' ORDER BY booking_operasi.tanggal,booking_operasi.jam_mulai");
                                ...
                                if((!empty($header['x-token'])) && (USERNAME==$header['x-username']) && (cektoken($header['x-token'])=='true')){
                                    if (empty($decode['nomorkartu'])){ 
                                        ...
                                        else
                                        {
                                            ...
                                            if(empty($arpxbaru['nomorkartu']))
                                            {
                                                $ins_pxbaru=InsertTmpPasienbaru($decode);
                                                if ($ins_pxbaru) 
                                                {
                                                    $response = array(
                                                        "metadata" => array(
                                                            "message" =>  "Pendaftaran rekam medis tidak dapat dilakukan dikarenakan: Nomor Rekam Anda JKN'".$decode['nomorkartu']."' tersebut hanya bersifat sementara. Harap datang ke admisi untuk verifikasi dan melengkapi data rekam medis dengan membawa kartu identitas. Pastikan data anda benar-benar valid dan belum pernah terdaftar di RS Bedah Surya Dharma Husada Jombang. Silahkan melakukan pendaftaran rekam medis dulu di Rumah Sakit. Terima Kasih",
                                                            "code" => 201
                                                        ),
                                                        "response" => array("norm"=>"JKN".$decode['nomorkartu'])
                                                    ); 
                                                    http_response_code(201);                                                        
                                                }
                                                else
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    $response = array(
                                                        'metadata' => array(
                                                            'message' =>  'Pasien dengan NIK dan No.Kartu tersebut sudah terdaftar di RS Bedah Surya Dharma Husada Jombang',
                                                            'code' => 201
                                                        )
                                                    ); 
                                                    http_response_code(201);    
                                        ...
                                        else
                                        {
                                           ...
                                           if($setrm["posisi_tahun_bulan"]=="Depan"){
                                            ...
                                            bukaquery3("insert ignore into kelurahan values('0','".validTeks($decode['namakel'])."')");
                                            bukaquery3("insert ignore into kecamatan values('0','".validTeks($decode['namakec'])."')");
                                            bukaquery3("insert ignore into kabupaten values('0','".validTeks($decode['namadati2'])."')");
                                            bukaquery3("insert ignore into propinsi values('0','".validTeks($decode['namaprop'])."')");

                                            $query = bukaquery2("insert into pasien values('$norm','".validTeks($decode['nama'])."','".validTeks($decode['nik'])."','".validTeks($decode['jeniskelamin'])."','-','".validTeks($decode['tanggallahir'])."','-','".validTeks($decode['alamat'])."','-','-','JOMBLO','-',current_date(),'".validTeks($decode['nohp'])."','0','-','SAUDARA','-','".CARABAYAR."','".validTeks($decode['nomorkartu'])."','".getOne2("select kelurahan.kd_kel from kelurahan where kelurahan.nm_kel='".validTeks($decode['namakel'])."'")."','".getOne2("select kecamatan.kd_kec from kecamatan where kecamatan.nm_kec='".validTeks($decode['namakec'])."'")."','".getOne2("select kabupaten.kd_kab from kabupaten where kabupaten.nm_kab='".validTeks($decode['namadati2'])."'")."','-','".validTeks($decode['alamat'])."','".validTeks($decode['namakel'])."','".validTeks($decode['namakec'])."','".validTeks($decode['namadati2'])."','-','1','1','1','-','-','".getOne2("select propinsi.kd_prop from propinsi where propinsi.nm_prop='".validTeks($decode['namaprop'])."'")."','".validTeks($decode['namaprop'])."')");
                                            if ($query) {
                                                $response = array(
                                                    'response' => array(
                                                        'norm' => $norm
